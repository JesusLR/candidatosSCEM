        ...
        */
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $correo_coordinador = $programa->empleado->empCorreo1 ? $programa->empleado->empCorreo1: null;
                $correo_director = $escuela->empleado->empCorreo1 ? $escuela->empleado->empCorreo1: null;
                ...
                if($correo_director) {
                    $mail->addCC($correo_director);
                }

                if(!$correo_coordinador && !$correo_director && $empleadoSeguimiento->isEmpty()) {
                    $mail->addAddress("luislara@modelo.edu.mx");
                }
